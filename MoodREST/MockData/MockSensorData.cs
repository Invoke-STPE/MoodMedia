    ...
    public class MockSensorData
    {
        public static IEnumerable<SensorData> GetMockData()
        {
            var data = new List<SensorData>() {
                new SensorData(1, "MockSensor 1", 20, 50, 800, new DateTime(2021,11,01,12,30,00)),
                new SensorData(2, "MockSensor 2", 21, 45, 900, new DateTime(2021,11,05,10,30,00)),
                new SensorData(3, "MockSensor 1", 21.5, 46.4, 850, new DateTime(2021,11,10,15,30,00)),
                ...
                new SensorData(6, "MockSensor 1", 23, 49, 800, new DateTime(2021,12,15,12,30,00)),
                new SensorData(7, "MockSensor 2", 28, 51, 900, new DateTime(2021,12,20,12,30,00)),
            };
            return data;
        }
    }
